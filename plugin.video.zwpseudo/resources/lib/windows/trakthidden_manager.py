		...
		try:
			if action in self.selection_actions:
				...
				if focus_id == 2040: # listItems
					...
					if chosen_listitem.getProperty('zwpseudo.isHidden') == 'true':
						...
						if chosen_listitem.getProperty('zwpseudo.isSelected') == '':
							chosen_listitem.setProperty('zwpseudo.isSelected', 'true')
		...
		def builder():
			for count, item in enumerate(self.results, 1):
				try:
					...
					listitem.setProperty('zwpseudo.tvshowtitle', item.get('tvshowtitle'))
					listitem.setProperty('zwpseudo.year', str(item.get('year')))
					listitem.setProperty('zwpseudo.isHidden', str(item.get('isHidden')))
					listitem.setProperty('zwpseudo.isSelected', str(item.get('isHidden')))
					listitem.setProperty('zwpseudo.imdb', item.get('imdb'))
					listitem.setProperty('zwpseudo.tmdb', str(item.get('tmdb')))
					listitem.setProperty('zwpseudo.tvdb', str(item.get('tvdb')))
					listitem.setProperty('zwpseudo.status', item.get('status'))
					try: listitem.setProperty('zwpseudo.watched_count', '(watched ' + str(item.get('watched_count').get('watched')) + ' of ' + str(item.get('watched_count').get('total')) + ')')
					except: pass
					...
					# listitem.setProperty('zwpseudo.duration', str(item.get('duration'))) # not used
